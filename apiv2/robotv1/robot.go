...
func (c *RESTClient) AddProjectRobotV1(ctx context.Context, projectNameOrID string, r *modelv2.RobotCreateV1) (*modelv2.RobotCreated, error) {
	...
	resp, err := c.V2Client.Robotv1.CreateRobotV1(params, c.AuthInfo)
...
func (c *RESTClient) UpdateProjectRobot(ctx context.Context, projectNameOrID string, robotID int64, r *modelv2.Robot) error {
...
func (c *RESTClient) DeleteProjectRobot(ctx context.Context, projectNameOrID string, robotID int64) error {
