...
// NewMockGcClientService creates a new instance of MockGcClientService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockGcClientService(t testing.TB) *MockGcClientService {
