...
// NewMockLabelClientService creates a new instance of MockLabelClientService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockLabelClientService(t testing.TB) *MockLabelClientService {
