...
// NewMockUserClientService creates a new instance of MockUserClientService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockUserClientService(t testing.TB) *MockUserClientService {
