...
import (
	...
	repository "github.com/mittwald/goharbor-client/v5/apiv2/internal/api/client/repository"
...
// NewMockRepositoryClientService creates a new instance of MockRepositoryClientService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockRepositoryClientService(t testing.TB) *MockRepositoryClientService {
