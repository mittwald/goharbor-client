...
// NewMockImmutableClientService creates a new instance of MockImmutableClientService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockImmutableClientService(t testing.TB) *MockImmutableClientService {
