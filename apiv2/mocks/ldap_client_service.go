...
// NewMockLdapClientService creates a new instance of MockLdapClientService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockLdapClientService(t testing.TB) *MockLdapClientService {
