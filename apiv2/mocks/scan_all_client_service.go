...
// NewMockScan_allClientService creates a new instance of MockScan_allClientService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockScan_allClientService(t testing.TB) *MockScan_allClientService {
