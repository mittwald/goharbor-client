...
import (
	artifact "github.com/mittwald/goharbor-client/v5/apiv2/internal/api/client/artifact"
...
// NewMockArtifactClientService creates a new instance of MockArtifactClientService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockArtifactClientService(t testing.TB) *MockArtifactClientService {
