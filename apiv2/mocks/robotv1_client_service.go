...
// NewMockRobotv1ClientService creates a new instance of MockRobotv1ClientService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockRobotv1ClientService(t testing.TB) *MockRobotv1ClientService {
