...
// NewMockMemberClientService creates a new instance of MockMemberClientService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockMemberClientService(t testing.TB) *MockMemberClientService {
