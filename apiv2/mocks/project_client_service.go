...
// NewMockProjectClientService creates a new instance of MockProjectClientService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockProjectClientService(t testing.TB) *MockProjectClientService {
