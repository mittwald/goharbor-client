...
func (o *PostScannersParams) WithRegistration(registration *model.ScannerRegistrationReq) *PostScannersParams {
	o.SetRegistration(registration)
	return o
}

// SetRegistration adds the registration to the post scanners params
func (o *PostScannersParams) SetRegistration(registration *model.ScannerRegistrationReq) {
