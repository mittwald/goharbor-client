...
func (o *PutProjectsProjectIDScannerParams) WithPayload(payload *model.ProjectScanner) *PutProjectsProjectIDScannerParams {
	o.SetPayload(payload)
	return o
}

// SetPayload adds the payload to the put projects project ID scanner params
func (o *PutProjectsProjectIDScannerParams) SetPayload(payload *model.ProjectScanner) {
	o.Payload = payload
}
