...
func (o *PutScannersRegistrationIDParams) WithRegistration(registration *model.ScannerRegistrationReq) *PutScannersRegistrationIDParams {
	o.SetRegistration(registration)
	return o
}

// SetRegistration adds the registration to the put scanners registration ID params
func (o *PutScannersRegistrationIDParams) SetRegistration(registration *model.ScannerRegistrationReq) {
