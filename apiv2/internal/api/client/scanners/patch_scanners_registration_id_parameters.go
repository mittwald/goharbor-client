...
func (o *PatchScannersRegistrationIDParams) WithPayload(payload *model.IsDefault) *PatchScannersRegistrationIDParams {
	o.SetPayload(payload)
	return o
}

// SetPayload adds the payload to the patch scanners registration ID params
func (o *PatchScannersRegistrationIDParams) SetPayload(payload *model.IsDefault) {
	o.Payload = payload
}
