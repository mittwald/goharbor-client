...
func (o *PostUsergroupsParams) WithUsergroup(usergroup *model.UserGroup) *PostUsergroupsParams {
	o.SetUsergroup(usergroup)
	return o
}

// SetUsergroup adds the usergroup to the post usergroups params
func (o *PostUsergroupsParams) SetUsergroup(usergroup *model.UserGroup) {
