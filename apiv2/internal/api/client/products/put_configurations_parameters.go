...
func (o *PutConfigurationsParams) WithConfigurations(configurations *model.Configurations) *PutConfigurationsParams {
	o.SetConfigurations(configurations)
	return o
}

// SetConfigurations adds the configurations to the put configurations params
func (o *PutConfigurationsParams) SetConfigurations(configurations *model.Configurations) {
