...
func (o *PutProjectsProjectIDWebhookPoliciesPolicyIDParams) WithPolicy(policy *model.WebhookPolicy) *PutProjectsProjectIDWebhookPoliciesPolicyIDParams {
	o.SetPolicy(policy)
	return o
}

// SetPolicy adds the policy to the put projects project ID webhook policies policy ID params
func (o *PutProjectsProjectIDWebhookPoliciesPolicyIDParams) SetPolicy(policy *model.WebhookPolicy) {
	o.Policy = policy
}
