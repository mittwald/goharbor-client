...
func (o *PostChartrepoRepoChartsNameVersionLabelsParams) WithLabel(label *model.Label) *PostChartrepoRepoChartsNameVersionLabelsParams {
	o.SetLabel(label)
	return o
}

// SetLabel adds the label to the post chartrepo repo charts name version labels params
func (o *PostChartrepoRepoChartsNameVersionLabelsParams) SetLabel(label *model.Label) {
	o.Label = label
}
