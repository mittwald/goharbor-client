...
func (o *PostLdapUsersImportParams) WithUIDList(uIDList *model.LdapImportUsers) *PostLdapUsersImportParams {
	o.SetUIDList(uIDList)
	return o
}

// SetUIDList adds the uidList to the post ldap users import params
func (o *PostLdapUsersImportParams) SetUIDList(uIDList *model.LdapImportUsers) {
	o.UIDList = uIDList
}
