...
func (o *PostProjectsProjectIDWebhookPoliciesParams) WithPolicy(policy *model.WebhookPolicy) *PostProjectsProjectIDWebhookPoliciesParams {
	o.SetPolicy(policy)
	return o
}

// SetPolicy adds the policy to the post projects project ID webhook policies params
func (o *PostProjectsProjectIDWebhookPoliciesParams) SetPolicy(policy *model.WebhookPolicy) {
	o.Policy = policy
}
