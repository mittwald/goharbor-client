...
type PutProjectsProjectIDImmutabletagrulesIDParams struct {
	...
	*/
	ID int64
	/*Immutabletagrule*/
	Immutabletagrule *model.ImmutableTagRule
	/*ProjectID
	  Relevant project ID.
...
func (o *PutProjectsProjectIDImmutabletagrulesIDParams) WithImmutabletagrule(immutabletagrule *model.ImmutableTagRule) *PutProjectsProjectIDImmutabletagrulesIDParams {
...
func (o *PutProjectsProjectIDImmutabletagrulesIDParams) SetImmutabletagrule(immutabletagrule *model.ImmutableTagRule) {
