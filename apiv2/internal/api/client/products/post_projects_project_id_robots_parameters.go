...
type PostProjectsProjectIDRobotsParams struct {
	...
	*/
	Robot *model.RobotAccountCreate
...
func (o *PostProjectsProjectIDRobotsParams) WithRobot(robot *model.RobotAccountCreate) *PostProjectsProjectIDRobotsParams {
	o.SetRobot(robot)
	return o
}

// SetRobot adds the robot to the post projects project ID robots params
func (o *PostProjectsProjectIDRobotsParams) SetRobot(robot *model.RobotAccountCreate) {
	o.Robot = robot
}
