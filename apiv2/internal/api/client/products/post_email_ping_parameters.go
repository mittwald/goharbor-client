...
type PostEmailPingParams struct {
	...
	*/
	Settings *model.EmailServerSetting
...
func (o *PostEmailPingParams) WithSettings(settings *model.EmailServerSetting) *PostEmailPingParams {
	o.SetSettings(settings)
	return o
}

// SetSettings adds the settings to the post email ping params
func (o *PostEmailPingParams) SetSettings(settings *model.EmailServerSetting) {
	o.Settings = settings
}
