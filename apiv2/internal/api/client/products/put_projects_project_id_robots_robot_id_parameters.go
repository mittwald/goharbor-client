...
type PutProjectsProjectIDRobotsRobotIDParams struct {
	...
	*/
	Robot *model.RobotAccountUpdate
	/*RobotID
...
func (o *PutProjectsProjectIDRobotsRobotIDParams) WithRobot(robot *model.RobotAccountUpdate) *PutProjectsProjectIDRobotsRobotIDParams {
	o.SetRobot(robot)
	return o
}

// SetRobot adds the robot to the put projects project ID robots robot ID params
func (o *PutProjectsProjectIDRobotsRobotIDParams) SetRobot(robot *model.RobotAccountUpdate) {
	o.Robot = robot
}
