...
func (o *PostSystemScanAllScheduleParams) WithSchedule(schedule *model.AdminJobSchedule) *PostSystemScanAllScheduleParams {
	o.SetSchedule(schedule)
	return o
}

// SetSchedule adds the schedule to the post system scan all schedule params
func (o *PostSystemScanAllScheduleParams) SetSchedule(schedule *model.AdminJobSchedule) {
	o.Schedule = schedule
}
