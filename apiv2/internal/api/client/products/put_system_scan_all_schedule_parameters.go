...
func (o *PutSystemScanAllScheduleParams) WithSchedule(schedule *model.AdminJobSchedule) *PutSystemScanAllScheduleParams {
	o.SetSchedule(schedule)
	return o
}

// SetSchedule adds the schedule to the put system scan all schedule params
func (o *PutSystemScanAllScheduleParams) SetSchedule(schedule *model.AdminJobSchedule) {
	o.Schedule = schedule
}
