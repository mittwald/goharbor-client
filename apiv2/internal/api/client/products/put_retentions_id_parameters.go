...
func (o *PutRetentionsIDParams) WithPolicy(policy *model.RetentionPolicy) *PutRetentionsIDParams {
	o.SetPolicy(policy)
	return o
}

// SetPolicy adds the policy to the put retentions ID params
func (o *PutRetentionsIDParams) SetPolicy(policy *model.RetentionPolicy) {
	o.Policy = policy
}
