...
func (o *PostProjectsProjectIDWebhookPoliciesTestParams) WithPolicy(policy *model.WebhookPolicy) *PostProjectsProjectIDWebhookPoliciesTestParams {
	o.SetPolicy(policy)
	return o
}

// SetPolicy adds the policy to the post projects project ID webhook policies test params
func (o *PostProjectsProjectIDWebhookPoliciesTestParams) SetPolicy(policy *model.WebhookPolicy) {
	o.Policy = policy
}
