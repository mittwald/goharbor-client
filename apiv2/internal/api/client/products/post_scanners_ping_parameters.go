...
func (o *PostScannersPingParams) WithSettings(settings *model.ScannerRegistrationSettings) *PostScannersPingParams {
	o.SetSettings(settings)
	return o
}

// SetSettings adds the settings to the post scanners ping params
func (o *PostScannersPingParams) SetSettings(settings *model.ScannerRegistrationSettings) {
	o.Settings = settings
}
