...
type PutUsersUserIDSysadminParams struct {
	...
	*/
	SysadminFlag *model.SysAdminFlag
	/*UserID
	  Registered user ID
...
func (o *PutUsersUserIDSysadminParams) WithSysadminFlag(sysadminFlag *model.SysAdminFlag) *PutUsersUserIDSysadminParams {
	o.SetSysadminFlag(sysadminFlag)
	return o
}

// SetSysadminFlag adds the sysadminFlag to the put users user ID sysadmin params
func (o *PutUsersUserIDSysadminParams) SetSysadminFlag(sysadminFlag *model.SysAdminFlag) {
