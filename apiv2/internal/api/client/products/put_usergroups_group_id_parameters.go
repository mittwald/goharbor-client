...
func (o *PutUsergroupsGroupIDParams) WithUsergroup(usergroup *model.UserGroup) *PutUsergroupsGroupIDParams {
	o.SetUsergroup(usergroup)
	return o
}

// SetUsergroup adds the usergroup to the put usergroups group ID params
func (o *PutUsergroupsGroupIDParams) SetUsergroup(usergroup *model.UserGroup) {
