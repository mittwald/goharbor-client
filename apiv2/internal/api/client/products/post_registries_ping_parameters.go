...
func (o *PostRegistriesPingParams) WithRegistry(registry *model.Registry) *PostRegistriesPingParams {
	o.SetRegistry(registry)
	return o
}

// SetRegistry adds the registry to the post registries ping params
func (o *PostRegistriesPingParams) SetRegistry(registry *model.Registry) {
	o.Registry = registry
}
