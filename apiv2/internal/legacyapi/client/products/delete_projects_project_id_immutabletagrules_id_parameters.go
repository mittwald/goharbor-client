...
func (o *DeleteProjectsProjectIDImmutabletagrulesIDParams) WithDefaults() *DeleteProjectsProjectIDImmutabletagrulesIDParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *DeleteProjectsProjectIDImmutabletagrulesIDParams) SetDefaults() {
