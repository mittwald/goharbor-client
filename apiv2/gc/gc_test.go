...
func TestRESTClient_NewSystemGarbageCollection(t *testing.T) {
	...
	err := cl.NewSystemGarbageCollection(ctx, schedule)
...
func TestRESTClient_GetSystemGarbageCollection(t *testing.T) {
	...
	gc, err := cl.GetSystemGarbageCollectionSchedule(ctx)
...
func TestRESTClient_GetSystemGarbageCollectionSchedule_ScheduleNil(t *testing.T) {
	p := &mocks.MockProductsClientService{}
	g := &mocks.MockGcClientService{}
	...
	_, err := cl.GetSystemGarbageCollectionSchedule(ctx)
...
func TestRESTClient_UpdateSystemGarbageCollection(t *testing.T) {
	...
	err := cl.UpdateSystemGarbageCollection(ctx, newGcReq)
...
func TestRESTClient_UpdateSystemGarbageCollection_ScheduleNil(t *testing.T) {
	...
	err := cl.UpdateSystemGarbageCollection(ctx, nil)
