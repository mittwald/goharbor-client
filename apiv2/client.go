...
func (c *RESTClient) NewSystemGarbageCollection(ctx context.Context, gcSchedule *modelv2.Schedule) error {
	return c.gc.NewSystemGarbageCollection(ctx, gcSchedule)
}

// UpdateSystemGarbageCollection wraps the UpdateSystemGarbageCollection method of the system sub-package.
func (c *RESTClient) UpdateSystemGarbageCollection(ctx context.Context, newGCSchedule *modelv2.Schedule) error {
	return c.gc.UpdateSystemGarbageCollection(ctx, newGCSchedule)
}

// GetSystemGarbageCollectionSchedule wraps the GetSystemGarbageCollection method of the system sub-package.
func (c *RESTClient) GetSystemGarbageCollectionSchedule(ctx context.Context) (*modelv2.GCHistory, error) {
	return c.gc.GetSystemGarbageCollectionSchedule(ctx)
}
...
func (c *RESTClient) ResetSystemGarbageCollection(ctx context.Context) error {
	return c.gc.ResetSystemGarbageCollection(ctx)
}
