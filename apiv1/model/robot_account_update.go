...
// ContextValidate validates this robot account update based on context it is used
func (m *RobotAccountUpdate) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
