...
// ContextValidate validates this robot account based on context it is used
func (m *RobotAccount) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
