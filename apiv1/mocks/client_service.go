...
import (
	...
	products "github.com/mittwald/goharbor-client/v5/apiv1/internal/api/client/products"
...
// NewMockClientService creates a new instance of MockClientService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockClientService(t testing.TB) *MockClientService {
