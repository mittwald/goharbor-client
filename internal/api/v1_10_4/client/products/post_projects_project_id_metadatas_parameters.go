...
type PostProjectsProjectIDMetadatasParams struct {
	...
	*/
	Metadata *v1_10_4.ProjectMetadata
	/*ProjectID
	  Selected project ID.
...
func (o *PostProjectsProjectIDMetadatasParams) WithMetadata(metadata *v1_10_4.ProjectMetadata) *PostProjectsProjectIDMetadatasParams {
	o.SetMetadata(metadata)
	return o
}

// SetMetadata adds the metadata to the post projects project ID metadatas params
func (o *PostProjectsProjectIDMetadatasParams) SetMetadata(metadata *v1_10_4.ProjectMetadata) {
	o.Metadata = metadata
}
