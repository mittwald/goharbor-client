...
type PostSystemGcScheduleParams struct {
	...
	*/
	Schedule *v1_10_4.AdminJobSchedule
...
func (o *PostSystemGcScheduleParams) WithSchedule(schedule *v1_10_4.AdminJobSchedule) *PostSystemGcScheduleParams {
	o.SetSchedule(schedule)
	return o
}

// SetSchedule adds the schedule to the post system gc schedule params
func (o *PostSystemGcScheduleParams) SetSchedule(schedule *v1_10_4.AdminJobSchedule) {
	o.Schedule = schedule
}
