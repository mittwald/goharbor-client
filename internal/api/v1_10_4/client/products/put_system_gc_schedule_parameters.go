...
func (o *PutSystemGcScheduleParams) WithSchedule(schedule *v1_10_4.AdminJobSchedule) *PutSystemGcScheduleParams {
	o.SetSchedule(schedule)
	return o
}

// SetSchedule adds the schedule to the put system gc schedule params
func (o *PutSystemGcScheduleParams) SetSchedule(schedule *v1_10_4.AdminJobSchedule) {
	o.Schedule = schedule
}
