...
func (o *PostRegistriesParams) WithRegistry(registry *v1_10_4.Registry) *PostRegistriesParams {
	o.SetRegistry(registry)
	return o
}

// SetRegistry adds the registry to the post registries params
func (o *PostRegistriesParams) SetRegistry(registry *v1_10_4.Registry) {
	o.Registry = registry
}
