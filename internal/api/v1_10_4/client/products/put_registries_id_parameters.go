...
type PutRegistriesIDParams struct {
	...
	*/
	RepoTarget *v1_10_4.PutRegistry
...
func (o *PutRegistriesIDParams) WithRepoTarget(repoTarget *v1_10_4.PutRegistry) *PutRegistriesIDParams {
	o.SetRepoTarget(repoTarget)
	return o
}

// SetRepoTarget adds the repoTarget to the put registries ID params
func (o *PutRegistriesIDParams) SetRepoTarget(repoTarget *v1_10_4.PutRegistry) {
