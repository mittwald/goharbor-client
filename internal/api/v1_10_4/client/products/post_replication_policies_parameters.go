...
func (o *PostReplicationPoliciesParams) WithPolicy(policy *v1_10_4.ReplicationPolicy) *PostReplicationPoliciesParams {
	o.SetPolicy(policy)
	return o
}

// SetPolicy adds the policy to the post replication policies params
func (o *PostReplicationPoliciesParams) SetPolicy(policy *v1_10_4.ReplicationPolicy) {
	o.Policy = policy
}
