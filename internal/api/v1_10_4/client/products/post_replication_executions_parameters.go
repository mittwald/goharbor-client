...
type PostReplicationExecutionsParams struct {
	...
	*/
	Execution *v1_10_4.ReplicationExecution
...
func (o *PostReplicationExecutionsParams) WithExecution(execution *v1_10_4.ReplicationExecution) *PostReplicationExecutionsParams {
	o.SetExecution(execution)
	return o
}

// SetExecution adds the execution to the post replication executions params
func (o *PostReplicationExecutionsParams) SetExecution(execution *v1_10_4.ReplicationExecution) {
