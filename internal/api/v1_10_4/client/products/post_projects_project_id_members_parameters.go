...
import (
	...
	"github.com/mittwald/goharbor-client/model/v1_10_4"
)
...
type PostProjectsProjectIDMembersParams struct {
	...
	*/
	ProjectID int64
	/*ProjectMember*/
	ProjectMember *v1_10_4.ProjectMember
...
func (o *PostProjectsProjectIDMembersParams) WithProjectMember(projectMember *v1_10_4.ProjectMember) *PostProjectsProjectIDMembersParams {
	o.SetProjectMember(projectMember)
	return o
}

// SetProjectMember adds the projectMember to the post projects project ID members params
func (o *PostProjectsProjectIDMembersParams) SetProjectMember(projectMember *v1_10_4.ProjectMember) {
