...
func (o *PutProjectsProjectIDMembersMidParams) WithRole(role *v1_10_4.RoleRequest) *PutProjectsProjectIDMembersMidParams {
	o.SetRole(role)
	return o
}

// SetRole adds the role to the put projects project ID members mid params
func (o *PutProjectsProjectIDMembersMidParams) SetRole(role *v1_10_4.RoleRequest) {
	o.Role = role
}
