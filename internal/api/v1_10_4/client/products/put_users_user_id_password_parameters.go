...
func (o *PutUsersUserIDPasswordParams) WithPassword(password *v1_10_4.Password) *PutUsersUserIDPasswordParams {
	o.SetPassword(password)
	return o
}

// SetPassword adds the password to the put users user ID password params
func (o *PutUsersUserIDPasswordParams) SetPassword(password *v1_10_4.Password) {
	o.Password = password
}
