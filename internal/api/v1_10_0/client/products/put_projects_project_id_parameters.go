...
func (o *PutProjectsProjectIDParams) WithProject(project *v1_10_0.ProjectReq) *PutProjectsProjectIDParams {
	o.SetProject(project)
	return o
}

// SetProject adds the project to the put projects project ID params
func (o *PutProjectsProjectIDParams) SetProject(project *v1_10_0.ProjectReq) {
	o.Project = project
}
