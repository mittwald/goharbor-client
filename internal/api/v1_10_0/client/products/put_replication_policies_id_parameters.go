...
type PutReplicationPoliciesIDParams struct {
	...
	*/
	Policy *v1_10_0.ReplicationPolicy
...
func (o *PutReplicationPoliciesIDParams) WithPolicy(policy *v1_10_0.ReplicationPolicy) *PutReplicationPoliciesIDParams {
	o.SetPolicy(policy)
	return o
}

// SetPolicy adds the policy to the put replication policies ID params
func (o *PutReplicationPoliciesIDParams) SetPolicy(policy *v1_10_0.ReplicationPolicy) {
	o.Policy = policy
}
