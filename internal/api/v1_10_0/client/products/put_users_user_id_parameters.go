...
func (o *PutUsersUserIDParams) WithProfile(profile *v1_10_0.UserProfile) *PutUsersUserIDParams {
	o.SetProfile(profile)
	return o
}

// SetProfile adds the profile to the put users user ID params
func (o *PutUsersUserIDParams) SetProfile(profile *v1_10_0.UserProfile) {
	o.Profile = profile
}
