...
func (o *PutSystemGcScheduleParams) WithSchedule(schedule *v1_10_0.AdminJobSchedule) *PutSystemGcScheduleParams {
	o.SetSchedule(schedule)
	return o
}

// SetSchedule adds the schedule to the put system gc schedule params
func (o *PutSystemGcScheduleParams) SetSchedule(schedule *v1_10_0.AdminJobSchedule) {
	o.Schedule = schedule
}
