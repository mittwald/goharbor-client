.PHONY: swagger-generate mock harbor-1.10.5 harbor-2.1.0 teardown-harbor test swagger-cleanup \
mock-cleanup integration-test-v1.10.5 integration-test-v2.1.0
